# Run Selenium Tests with pytest on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Python pytest automation tests across real browsers and operating systems. This sample shows how to configure Python + pytest to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/pytest-selenium-sample && cd pytest-selenium-sample
